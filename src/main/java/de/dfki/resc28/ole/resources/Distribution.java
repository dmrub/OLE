...
public class Distribution extends Resource implements IResource
{

	public Distribution(String resourceURI, IGraphStore graphStore) 
	{
		super(resourceURI, graphStore);
		this.fRDFType = ADMS.AssetDistribution;
	}
